...
--
-- Host: localhost
-- Generation Time: Mar 10, 2020 at 01:08 AM
...
(3, 'Julius Caesar', 'csar', '$2y$10$42cIYSUs/ZuZJgk//6VWY.Ub7p.1L871WxoF4Q1fwisHfoQqWwp9e', '6395ebd0f4b478145ecfbaf939454fa4', 'me@mail.me', '07070707', '0010', 1);
...
CREATE TABLE `complaints` (
  ...
  `cstatus` enum('Unread','Read') NOT NULL,
  `fid` int(11) NOT NULL
...
INSERT INTO `complaints` (`cid`, `ctitle`, `cdescription`, `cstatus`, `fid`) VALUES
(1, 'Hello', 'Complaint', 'Unread', 3),
(2, 'fd', 'df', 'Unread', 3),
(5, 'STUPID CODE', 'LOJBVGH CKGDVCIDHCG CIFUDHBC CEUYG', 'Unread', 3),
(6, 'hello', 'good', 'Unread', 3),
(7, 'Hello', 'ejkddfkje ', 'Unread', 3);
...
(3, 'Kaivalya Hemant Mendki', 'ThePhenom', '$2y$10$1uqsuPR7fGj1g7qxohdJx.ppmayFzK/6uZr91zWb5RnH7IRCYBpsG', 'fe8c15fed5f808006ce95eddb7366e35', 'kmendki98@gmail.com', '8600611198', 'abcde', 0, 0, 'png', 0);
...
(3, 31, 'Hello Fruit', 'Vegetable', 'Great tasty and awesome', 200, 'blank.png', 0),
(3, 32, 'Great vege', 'Vegetable', 'awesome and greatest', 200, 'Great vege3.jpg', 1);
...
(2, 3, 30, 'hello', 'hello', '0707220932', 'me@e.e', 'eeue', 'eieueu'),
(3, 3, 28, 'meme', 'meme', '070707070', 'me@me.me', '0000', '001');
